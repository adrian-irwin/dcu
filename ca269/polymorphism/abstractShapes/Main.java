public class Main {
    public static ShapeWow largest(ShapeWow [] shapes)
    {
       if(shapes.length == 0)
          return null;
       ShapeWow largest = shapes[0]; // Assume it's the first
    ...
    public static void main(String [] args)
    {
       ...
       System.out.println("Average area is: " + Average.averageArea(shapes));
    }
