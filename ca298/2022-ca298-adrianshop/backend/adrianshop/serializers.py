...
class OrderSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Order
        fields = ['id', 'date_ordered', 'basket_id', 'user_id', 'total_price', 'shipping_address']

class BasketItemSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = BasketItem
        fields = ['id', 'basket_id', 'product_id', 'quantity', 'date_added', 'product_name', 'item_price']
...
class BasketSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Basket
        fields = ['id', 'user_id', 'is_active', 'date_made', 'items']
